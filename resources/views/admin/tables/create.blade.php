                        ...
                        <div class="flex  flex-wrap ">
                            ...
                            <fieldset>
                                ...
                                <div class="flex items-center mb-4">
                                  <input id="status-1" type="radio" name="status" value="pending" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" >
                                ...
                                <div class="flex items-center mb-4">
                                    <input id="status-1" type="radio" name="status" value="avaliable" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" >
                                    <label for="status-1" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                      {{-- @foreach (App\Enums\TableLocation::cases() as $location )
                                          {{ $location }}
                                      @endforeach --}}
                                  ...
                                  <div class="flex items-center mb-4">
                                    <input id="status-1" type="radio" name="status" value="unavaliable" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" >
                                    <label for="status-1" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                      {{-- @foreach (App\Enums\TableLocation::cases() as $location )
                                          {{ $location }}
                                      @endforeach --}}
                            ...
                            <fieldset>
                                ...
                                <div class="flex items-center mb-4">
                                  <input id="location-1" type="radio" name="location" value="outside" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" >
                                ...
                                <div class="flex items-center mb-4">
                                    <input id="location-1" type="radio" name="location" value="inside" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" >
                                    <label for="location-1" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                      {{-- @foreach (App\Enums\TableLocation::cases() as $location )
                                          {{ $location }}
                                      @endforeach --}}
                                  ...
                                  <div class="flex items-center mb-4">
                                    <input id="location-1" type="radio" name="location" value="inside vip" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" >
                                    <label for="location-1" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                      {{-- @foreach (App\Enums\TableLocation::cases() as $location )
                                          {{ $location }}
                                      @endforeach --}}

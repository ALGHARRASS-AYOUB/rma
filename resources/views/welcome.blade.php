<x-guest-layout>
 ...
 style="background-image: url('https://www.womansworld.com/wp-content/uploads/2017/09/what-foods-cause-nightmares-chicken.jpg')">
 <h1
   class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-200 to-green-400 md:text-center sm:leading-none lg:text-5xl">
   <span class="inline md:block">Welcome To OUR Restaurant</span>
 </h1>
 <div class="mx-auto mt-2 text-green-100 md:text-center font-bold m-3 lg:text-lg">
 ...
 <div class="flex flex-col items-center mt-12 text-center text-lg font-bold m-3">
   <span class="relative inline-flex w-full md:w-auto">
     <a href="{{ route('reservation.stepOne') }}" type="button"
       class="inline-flex items-center justify-center px-6 py-2 text-base font-bold leading-6 text-white bg-green-700 rounded-full lg:w-full md:w-auto hover:bg-green-800 focus:outline-none">
...
<section id="about-us" class="py-20 bg-gray-50">
 <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
   <div class="flex flex-wrap items-center -mx-3">
     ...
     <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
         ...
         src="https://i.pinimg.com/564x/90/d1/e0/90d1e097425a4ed24d70e3c778441b81.jpg" alt="feature image"></div>
   </div>
 </div>
</section>
<section class="mt-8 bg-white">
 ...
 <div class="container w-full px-5 py-6 mx-auto">
   <div class="grid lg:grid-cols-4 gap-y-6">
     ...
     @foreach ($specialCategory->menus as $menu)
                {{-- the bloc menu --}}
            <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                ...
                <div class="flex items-center justify-between p-4">
                    <span class="text-xl text-green-600">{{ $menu->price }} MAD</span>
                  </div>
              </div>
  {{-- end bloc menu --}}
...
<section class="pt-4 pb-12 bg-gray-800">
 <div class="my-16 text-center">
   <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
     Our Team </h2>
   <p class="text-xl text-white">the Best team ever with a big experiences in coocking feild, supervised by great cheifs.</p>
 </div>
